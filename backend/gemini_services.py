...
from backend.ai_service import chat_with_civic_assistant as _chat_with_civic_assistant
from backend.ai_service import generate_action_plan as _generate_action_plan
