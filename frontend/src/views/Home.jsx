          ...
          <AnimatePresence>
            {showScrollTop && (
              <motion.button
                ...
                onClick={scrollToTop}
                className="fixed right-8 bottom-24 sm:bottom-12 lg:bottom-8 bg-blue-600 hover:bg-blue-700 text-white p-4 rounded-full shadow-lg hover:shadow-2xl z-[9999] cursor-pointer"
