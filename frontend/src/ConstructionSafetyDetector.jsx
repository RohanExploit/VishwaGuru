  ...
  return (
    <div className="flex flex-col h-full bg-gray-50 p-4">
      <div className="flex items-center justify-between mb-4">
        <button onClick={onBack || (() => navigate('/'))} className="text-blue-600 font-bold flex items-center">
           &larr; Back
        </button>
        <h2 className="text-xl font-bold text-gray-800">Construction Safety</h2>
            ...
            <div className="relative w-full h-full">
               ...
               {detections.length > 0 && (
                 <div className="absolute bottom-0 left-0 right-0 bg-black/70 text-white p-4 backdrop-blur-md">
                    <h3 className="font-bold text-red-400 mb-2 uppercase tracking-wider text-xs">Violations Detected:</h3>
        ...
        {!imgSrc ? (
           ...
           <>
             ...
             <button
                ...
                disabled={loading}
                className="px-6 py-3 rounded-xl bg-blue-600 text-white font-bold shadow-lg flex items-center gap-2"
             >
      ...
      <p className="text-center text-xs text-gray-400">
          Detects: Workers without helmets, unsafe scaffolding, general site hazards.
      </p>
    </div>
  );
};
