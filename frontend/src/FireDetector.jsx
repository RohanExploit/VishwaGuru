...
const FireDetector = ({ onBack }) => {
  ...
  return (
    <div className="flex flex-col h-full">
        ...
        <h2 className="text-2xl font-bold mb-4 text-orange-600">Fire & Smoke Detector</h2>
        ...
        <p className="mt-4 text-sm text-gray-600 text-center">
            Point camera at smoke or fire to detect. Call emergency services for real fires.
        </p>
        </div>
    </div>
  );
